plugins {
    ...
    id ("org.danilopianini.git-sensitive-semantic-versioning") version "1.1.15"
...
dependencies {
    ...
    testImplementation("io.kotest:kotest-assertions-core:5.8.1") // for kotest core assertions
    testImplementation("io.kotest:kotest-assertions-core-jvm:5.8.1") // for kotest core jvm assertions
}
